...
class VOmniSearchApplicationTests {
    ...
    void contextLoads() throws IOException, InterruptedException {
        float[] userQueryVector = documentUserProfileService.getUserQueryVector("170452383233609728");
        List<RecommendMediaVo> recommendMediaVos = documentVectorMediaService.searchByProfileVector(userQueryVector, 6);
        for (RecommendMediaVo recommendMediaVo : recommendMediaVos) {
            System.out.println(recommendMediaVo.getTitle());
        }
    }
