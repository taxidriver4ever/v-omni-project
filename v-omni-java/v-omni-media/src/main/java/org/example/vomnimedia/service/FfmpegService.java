...
public interface FfmpegService {
     ...
     */
    String compressAndConvertToHLSAndUploadToMinio(String id,String inputVideoUrl, String bucketName, int crf, String maxBitrate)
            throws Exception;

    default String compressAndConvertToHLSAndUploadToMinio(String id,String inputVideoUrl, String bucketName) throws Exception {
        return compressAndConvertToHLSAndUploadToMinio(id,inputVideoUrl, bucketName, 24, "3000k");
    }
